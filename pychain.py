...
# Set Streamlit page config to see wide view of the block ledger.
...
# Receiving input value as number with two decimals.
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        #Ensuring amount float is converted to float
